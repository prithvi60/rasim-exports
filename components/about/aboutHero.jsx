    ...
    return (
        <section className="relative flex flex-col-reverse items-center w-full h-screen gap-8 px-6 py-10 mt-5 overflow-hidden md:mt-0 mt- md:justify-between md:flex-row md:px-14 xl:px-32">
            ...
            <div className='relative w-full h-[420px]'>
                <div className='absolute top-6 sm:top-16 right-40 sm:right-44 lg:right-56 xl:right-64 w-[160px] sm:w-[180px] h-[250px] sm:h-[280px] lg:w-[210px] overflow-hidden lg:h-[340px] customBorder'>
