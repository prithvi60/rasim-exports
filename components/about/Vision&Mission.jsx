...
const VisionMission = () => {
    ...
    return (
        <>
            ...
            <section name="vision" id="vision" className="flex flex-col items-center justify-between gap-6 px-6 py-10 lg:flex-row md:px-14 xl:px-32">
                <div className='size-[320px] sm:size-[460px] p-3.5 bg-primary rounded-full flex justify-center items-center'>
                    <div className='size-[290px] sm:size-[430px] p-3.5 bg-secondary rounded-full flex justify-center items-center'>
                        <div className='size-[260px] sm:size-[400px] p-3.5 bg-primary rounded-full flex justify-center  items-center'>
                            <div className='size-[230px] sm:size-[370px] flex flex-col items-center justify-start ga-2 sm:gap-7 w-full bg-white rounded-full py-3.5 sm:py-7 px-9 overflow-scroll no-scrollbar'>
                                ...
                                <p className='mb-5 text-sm font-normal text-justify sm:text-base font-figtree sm:mb-0'>Since <span className='text-3xl sm:text-[40px] font-libreCaslonDisplay font-medium whitespace-nowrap text-secondary'>2002</span> Rasim Exports Pvt Ltd has been at the heart of apparel manufacturing, committed to crafting high-quality clothing for men, women, and children. Our journey is driven by a passion for excellence and a dedication to sus</p>
                            </div>
                        </div>
                    </div>
                </div>
