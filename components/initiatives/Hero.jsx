    ...
    return (
        <section className="relative w-full h-screen 2xl:h-[65vh] overflow-hidden slider-container">
            <div className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 flex flex-col sm:flex-row justify-center items-center gap-3 flex-wrap font-bold rounded-md py-2 px-3.5 z-10 w-full lg:w-3/5">
                <div className='flex flex-col w-full gap-2 p-3 md:gap-5 xl:w-4/5 backdrop-brightness-75'>
                    <h1 className='font-bold uppercase text-4xl sm:text-[64px] md:text-[74px] lg:text-[68px] xl:text-[74px] font-libreCaslonDisplay text-primary w-full text-center leading-8 lg:!leading-[30px] tracking-custom'>RASIM EXPORTS</h1>
                    ...
                    <p className='text-base italic font-semibold md:text-xl font-figtree text-primary !leading-[30px] text-center tracking-custom'>MANUFACTURERS AND EXPORTERS OF FASHION APPARELS</p>
