...
const Hero = () => {
    ...
    return (
        <section className="relative w-full h-screen overflow-hidden slider-container">
            <div className="absolute bottom-5 right-0 flex flex-col sm:flex-row justify-center items-center gap-3 flex-wrap font-bold rounded-md py-2 px-3.5 z-10 w-full lg:w-3/5">
                <div className='flex flex-col justify-between items-end gap-14 p-2 sm:w-[90%] w-full'>
                    <h1 className='font-medium uppercase text-2xl md:text-4xl lg:text-[48px] font-libreCaslonDisplay text-white leading-8 lg:!leading-[50px] tracking-custom text-end'>Lorem ipsum dolor sit amet consectetur. Suscipit</h1>
