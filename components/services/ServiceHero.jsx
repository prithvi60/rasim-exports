...
const ServiceHero = () => {
    return (
        <section className="relative flex flex-col-reverse items-center w-full h-screen 2xl:h-[65vh] gap-8 px-6 py-10 mt-5 overflow-hidden md:mt-0 md:justify-between md:flex-row md:px-14 xl:px-32">
