    ...
    return (
        <section className='grid grid-cols-1 gap-5 px-6 py-10 sm:grid-cols-2 lg:grid-cols-3 md:px-14 xl:px-32'>
            <div className='block space-y-6 rounded-tl-[20px] bg-primary p-5 '>
                <div className='p-2 w-max rounded-tl-[14px]'>
